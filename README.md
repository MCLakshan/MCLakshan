...
## Industry & Applied Interests

- Game Development (Unity / Unreal Engine)  
- Graphics-Based Simulation Systems  
- Performance-Oriented Rendering Pipelines  
- ML-Integrated Interactive Systems  
- Technical Game Tools & Engine-Level Systems  
...
**Undergraduate Research – Environment-Aware Tree Generation (2025–Present)**  
Formulated tree generation as a rooted graph prediction problem with node-level geometric attributes.  
Designed a two-stage hybrid pipeline: ML-based structural prediction followed by procedural environmental adaptation.
